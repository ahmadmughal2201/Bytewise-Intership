            ...
            <div className='felx-2 text-gray-700 p-20 '>
              ...
              <div className='mt-3'>
                <div className='pb-4'>
                  ...
                  <input className='border-2 border-gray-500 rounded-md w-full p-2' type='text' name='name' placeholder='Enter your name'
              ...
              <div className='mt-3'>
                <div className='pb-4'>
                  ...
                  <input className='border-2 border-gray-500 rounded-md w-full p-2' type='text' name='country' placeholder='Enter your Country'
              ...
              <div className='mt-3'>
                <div className='pb-4'>
                  ...
                  <input className='border-2 border-gray-500 rounded-md w-full p-2' type='password' name='password' placeholder='Enter your password'
              ...
              <button className='bg-teal-500 font-bold text-white mt-6 py-3 w-full rounded-md' onClick={handleSubmit} type='submit' >Submit</button>
